// Forked from https://github.com/GoogleChromeLabs/dark-mode-toggle
// What I fixed are
// - move _initializedDOM to connectedCallback() to meet web component specification.
// - fix: permanent option might set empty value to the localStorage.
// related documents:
// - https://html.spec.whatwg.org/multipage/custom-elements.html#custom-element-conformance
// TODO: Submit PR later
...
export class DarkModeToggle extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    if (name === MODE) {
      ...
      // Only save if the mode is properly set.
      if (this.permanent && this.mode) {
        store.setItem(NAME, this.mode);
      }
      this._permanentCheckbox.checked = this.permanent;
    } else if (name === LEGEND) {
...
const DarkModeToggleButton = () => {
  return <dark-mode-toggle permanent />;
}
